...
<html lang="en">
  <head>
    ...
    <title>Feedback Institusi</title>
...
<body>
	 <div class="jumbotron">
       <h3 class="blue" style="color:white;margin-left:10px"><img class="responsive" width="30px" height="30px" src="https://kemahasiswaan.itb.ac.id/images/itb.png">&nbsp;Feedback Institusi</h3>
	...
	<div class="container">
		<div class="panel panel-default">
          ...
          <br>
		  <br>
		  	<form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?= base_url('Pengaduan/proc_add_feedback_institusi') ?>">
                <div style="margin:3px" class="form-group">
                        <label for="exampleInputEmail1">1. Seberapa penting layanan Bimbingan Konseling bagi Anda?</label> <br>
                        <input name="q1" type="radio" value="Sangat Penting" required> Sangat Penting <br>
                        <input name="q1" type="radio" value="Penting"> Penting <br>
                        <input name="q1" type="radio" value="Cukup Penting"> Cukup Penting<br>
                        <input name="q1" type="radio" value="Kurang Penting"> Kurang Penting<br>
                        <input name="q1" type="radio" value="Tidak Penting"> Tidak Penting<br>
                </div>
                <div style="margin:3px" class="form-group">
				    <label for="exampleInputEmail1">2. Seberapa puas Anda dengan layanan di Bimbingan Konseling ITB?</label> <br>
				    <input name="q2" type="radio" value="Sangat Puas" required> Sangat Puas <br>
					<input name="q2" type="radio" value="Puas"> Puas <br>
					<input name="q2" type="radio" value="Cukup Puas"> Cukup Puas<br>
					<input name="q2" type="radio" value="Kurang Puas"> Kurang Puas<br>
                    <input name="q2" type="radio" value="Tidak Puas"> Tidak Puas<br>
				</div>
				<div style="margin:3px" class="form-group">
                        <label for="exampleInputEmail1">Pesan dan Kesan Untuk Institusi Bimbingan Konseling ITB</label> <br>
                        <textarea required name="kesan_pesan" class="form-control"> </textarea>
                </div>
                <hr>
