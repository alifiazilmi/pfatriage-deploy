                                        ...
                                        <div class="tab-base">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div id="demo-lft-tab-2" class="tab-pane active in">
                                                    ...
                                                    <form class="form-horizontal" method="POST" action="<?= base_url('Pengaduan_admin/simpanpendaftar') ?>">
                                                    <input type="hidden" name="id_bk_form_pengaduan_mhs_bermasalah" value="<?php echo $id_bk_form_pengaduan_mhs_bermasalah;?>">
                                                            ...
                                                            <hr>
                                                                     <div class="panel-body">
                                                                             <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                     <input type="text" name="nim" value="<?php echo $nim;?>" class="form-control" id="nim" required>
                                                                                </div>
                                                                            </div>
