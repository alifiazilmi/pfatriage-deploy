                                ...
                                <div class="nano-content">
                                    <ul id="mainnav-menu" class="list-group">
                                        ...
                                        <li>
                                         ...
                                         <li class="list-divider"></li>
                                        <!--Category name-->
                                        <li class="list-header">Rekapitulasi </li>
                                         ...
                                         <li>
                                            <a href="<?= base_url('admin/data_konseling') ?>">
                                            <i class="fa fa-file "></i>
                                            <span class="menu-title">
                                               Data Konseling
                                            </span>
            ...
            $('#zselesai').datetimepicker({
             ...
             $(document).ready( function () {
                    ...
                    $('#demo-dt-basic').dataTable({
                        ...
                        $('#pengaduan_blm_disetujui').dataTable({
                        "bPaginate": true,
                        "bLengthChange": false,
                        "bFilter": true,
                        "bInfo": false,
                ...
                <script type="text/javascript">
                                                                    ...
                                                                    if (retur != '') {
                                                                        $data_dsti1 = JSON.parse(retur);
                                                                         ...
                                                                         if (data.length == 0) {
                                                                            ...
                                                                            $('#nama').val($data_dsti1.data[0].nama_lengkap);
                                                                            $('#email').val($data_dsti1.data[0].mail_non_itb);
                                                                        }
                                                                                      ...
                                                                                      $.ajax({
                                                                                         ...
                                                                                         .success(function( msg2 ) {
                                                                                                    ...
                                                                                                    console.log(data_kemahasiswaan);
                 ...
                 <script type="text/javascript">
                      ...
                      $('#stats').on('change', function() {
                        ...
                        if(this.value == '2'){
                            $('#boxtambahan').addClass('hidden');
                        }else if(this.value == '3' || this.value == '4' ){
                              $('#boxtambahan').removeClass('hidden');
                        }else{
                            $('#boxtambahan').addClass('hidden');
                        }
              ...
              <script type="text/javascript">
                    ...
                    $('#role').on('change', function() {
                        ...
                        $html = ' <div class="form-group">'+
                                                    '<label class="col-sm-3 control-label" for="demo-hor-inputpass">Penugasaan</label>'+
                                                    '<div class="col-sm-9">'+
